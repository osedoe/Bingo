...
},{"buffer":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"js/app.js":[function(require,module,exports) {
var _ = require('lodash'); // Variables
...
var balls = _.shuffle(_.range(1, 91));
...
var generate15RandomNumbers = function generate15RandomNumbers() {
...
var createCard = function createCard(classDiv) {
  ...
  var parent = document.querySelector(classDiv);
  var boardNumbers = generate15RandomNumbers(); // We are going to iterate over the {array}boardNumbers and create each element in the html
...
var crossNumber = function crossNumber(number) {
  var classNumberName = ".number".concat(number);
  var numberToCross = document.querySelectorAll(classNumberName);

  for (var i = 0; i < numberToCross.length; i++) {
...
rollBtn.addEventListener('click', function () {
  ...
  crossNumber(number); // check winner

  checkWinner(); // comprobar empate
});
